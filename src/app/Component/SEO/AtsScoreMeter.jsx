...
export default function AtsScoreMeter({ resumeData, selectedRole = null }) {
  ...
  return (
    <div className={`rounded-2xl border ${status.border} bg-white p-4 shadow-md transition-all`}>
