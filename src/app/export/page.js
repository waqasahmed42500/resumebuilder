...
function ExportContent() {
  ...
  const templateComponents = {
    resume1: Resume1, resume2: Resume2, resume3: Resume3, resume4: Resume4, resume5: Resume5,
    resume6: Resume6, resume7: Resume7, resume8: Resume8, resume9: Resume9, resume10: Resume10,
    resume11: Resume11, resume12: Resume12, resume13: Resume13, resume14: Resume14, resume15: Resume15,
    resume16: Resume16, resume17: Resume17, resume18: Resume18, resume19: Resume19, resume20: Resume20,
  };
  ...
  const handleDownloadPdf = async () => {
    ...
    previewNode.classList.add('export-mode');
    ...
    try {
      ...
      previewNode.classList.remove('export-mode');
    ...
    <>
        ...
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 px-1 sm:px-2 md:grid-cols-12 xl:gap-8">
          <div className="order-2 space-y-6 md:col-span-4 xl:col-span-3 xl:order-1">
            ...
            <section className="relative overflow-hidden rounded-[24px] bg-slate-900 p-6 text-white shadow-[0_20px_60px_rgba(15,23,42,0.16)]">
              ...
              <div className="absolute -bottom-10 -right-10 h-32 w-32 rounded-full bg-emerald-400/30 blur-3xl" />
            </section>
          </div>
      ...
      <div className="fixed bottom-6 left-1/2 z-[100] flex max-w-[calc(100%-1.5rem)] -translate-x-1/2 flex-wrap items-center justify-center gap-3 rounded-full border border-emerald-200 bg-slate-900 px-4 py-3 shadow-2xl sm:bottom-8 sm:px-6">
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-500/15">
          <span className="text-lg text-emerald-400"><FaCheckCircle /></span>
        </div>
