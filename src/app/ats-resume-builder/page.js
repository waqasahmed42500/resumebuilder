...
const atsFaqs = [
  ...
  {
    question: "How does ResumeArchitect guarantee ATS compatibility?",
    answer:
      "All ResumeArchitect templates use standard HTML5 typography hierarchies, standard section headings (Work Experience, Education, Skills), single/dual clean text blocks, and vector PDF encoding that ATS parsers extract without layout corruption.",
  },
  {
