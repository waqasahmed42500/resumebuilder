...
const Resume9 = memo(function Resume9({ data: propData, theme, readOnly = false }) {
  ...
  return (
    <TemplateWrapper theme={theme} readOnly={readOnly} className="bg-white flex flex-col">
      {/* Top Banner */}
      <header className="px-10 py-8 border-b border-slate-200 flex justify-between items-center bg-slate-50">
        <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {skills.map((skill, index) => (
                <div key={index} className="group/item relative inline-flex items-center">
                  <span className="rounded border bg-slate-50 px-2.5 py-1 text-[10px] font-medium text-slate-800" style={{ borderColor: `${accent}40` }}>
